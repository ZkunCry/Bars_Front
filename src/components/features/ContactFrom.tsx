...
import { BotService } from "@/src/services/BotServices";
export const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await BotService.createAndSendRequest({
        name: formState.name,
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex bg-black text-white py-2 px-6 rounded-md hover:bg-gray-800 transition disabled:opacity-50 cursor-pointer"
      >
        {formState.loading ? (
          <>
            <svg
